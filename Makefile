...
LDFLAGS=$(shell llvm-config --ldflags --system-libs --libs all) /usr/local/Cellar/boost/1.62.0/lib/libboost_program_options.a
COMPILER_OBJS=CodeGenerator.o Lexer.o Parser.o
